...
export default function Navigation() {
  ...
  const toggleButton = (
    <button
      ...
      className="flex items-center gap-1 rounded border border-gray-200 px-2 py-1.5 text-xs text-gray-500 hover:bg-gray-100"
    >
      {isMobile ? (
        <>
          <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <header className="border-b border-gray-200 bg-white">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3">
        ...
        >
          ...
          <span className="text-sm font-bold tracking-wide text-white">Music Fes!</span>
        </Link>
        ...
        {isMobile ? (
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="flex h-9 w-9 items-center justify-center rounded border border-gray-200 text-gray-500 hover:bg-gray-100"
              aria-label="メニュー"
            >
              {menuOpen ? (
      ...
      {isMobile && menuOpen && (
        <nav className="border-t border-gray-100 bg-white px-4 py-2">
          ...
          <button
            ...
            className="flex w-full items-center gap-3 rounded px-3 py-3 text-sm text-gray-500 hover:bg-gray-100"
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4" />
              <polyline points="16 17 21 12 16 7" />
